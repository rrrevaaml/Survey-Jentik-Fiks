...
var format_vektorreva_2 = new ol.format.GeoJSON();
var features_vektorreva_2 = format_vektorreva_2.readFeatures(json_vektorreva_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_vektorreva_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_vektorreva_2.addFeatures(features_vektorreva_2);
var lyr_vektorreva_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_vektorreva_2, 
                style: style_vektorreva_2,
                popuplayertitle: "vektor reva",
                interactive: true,
                title: '<img src="styles/legend/vektorreva_2.png" /> vektor reva'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_ADMCIMAHI_1.setVisible(true);lyr_vektorreva_2.setVisible(true);lyr_SUNGAI_AR_25K_3.setVisible(true);lyr_Buffered_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_ADMCIMAHI_1,lyr_vektorreva_2,lyr_SUNGAI_AR_25K_3,lyr_Buffered_4];
...
lyr_vektorreva_2.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_vektorreva_2.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
...
lyr_vektorreva_2.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
